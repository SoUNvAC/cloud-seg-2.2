...
if __name__ == "__main__":
    ...
    parser.add_argument("--base-root", default="data")
    parser.add_argument("--repo", required=True, help="Hugging Face dataset repo_id")
    args = parser.parse_args()
    for dataset_name in dataset_names:
        dataset_path = os.path.join(args.base_root, dataset_name)
        ...
        upload_zip_to_hub(dataset_name, zip_path, args.repo)
