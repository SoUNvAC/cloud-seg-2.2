...
def get_args():
    ...
    parse.add_argument(
        ...
        default="data/raw/cloudsen12_high",
    )
    parse.add_argument(
        "--save_path", type=str, help="数据集保存路径", default="data"
    )
...
if __name__ == "__main__":
    # Example: python tools/convert_datasets/create_l1c_l2a.py --root data/raw/cloudsen12_high --save_path data
